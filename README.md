...
(2) Install Anbox can substitute driver/ashmem and driver/binder (option)
...
(5) build libs servicemanager test_client test_server on x86_64/arm64 embedded system
    ...
    CONFIG_ASHMEM=y       #if linux version under 5.18.1 enable this, disable CONFIG_MEMFD_CREATE
    CONFIG_MEMFD_CREATE=y #if linux version after 5.18.1 enable this, disable CONFIG_ASHMEM
    CONFIG_ANDROID=y
